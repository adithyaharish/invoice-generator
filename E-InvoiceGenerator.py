...
def printinvoice():
    ...
    pdf= canvas.Canvas("D:\\InvoiceGenerator\\"+str(int(head.InvoiceNumber))+".pdf")
    ...
    pdf.save()
    webbrowser.open("D:\\InvoiceGenerator\\"+str(int(head.InvoiceNumber))+".pdf")
